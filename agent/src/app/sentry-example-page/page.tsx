    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://agent-app.sentry.io/issues/?project=4510097591173120">Issues Page</a>.
